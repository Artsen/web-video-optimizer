      ...
      <SettingsGroup icon={<Volume2 size={18} />} title="Audio">
        ...
        <label>
          ...
          <select
            ...
            onChange={(event) => setSettings({ ...settings, audioCodec: event.target.value as Settings["audioCodec"] })}
          >
        ...
        <label>
          ...
          <input
            ...
            placeholder="Keep source"
            onChange={(event) =>
              setSettings({ ...settings, audioSampleRate: event.target.value ? Number(event.target.value) : undefined })
            }
          />
        </label>
        <label>
